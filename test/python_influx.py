...
def get_ifdb(db, host='100.100.100.225', port=8086, user='buscrol', passwd='yangju#bu1'):
    ...
    try:
        ...
        def bus_data(ifdb):
            ...
            for busLocationList in locations:
                ...
                result = ifdb.query('SHOW TAG VALUES FROM SAWAYG1300 with key = "nowtime"')
