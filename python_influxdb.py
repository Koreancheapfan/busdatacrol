...
def get_ifdb(db, host='100.100.100.225', port=8086, user='ssg', passwd='qwer1234'):
    ...
    def bus_data(ifdb):
        ...
        for busLocationList in locations:
            ...
            if len(Awaybuslist) == 0 or plateNo not in Homebuslist:
                if stationId == "123000611" and plateNo not in Awaybuslist:  # 만약 기점 정류장이면 기점 정류장에있는 버스 정보 저장
